...
describe('RAWM mouse parameter snapshot', () => {
  it('recreates the confirmed complete 51-byte parameter body', () => {
    expect([...encodeMouseParamBody(parseMouseParamState(raw))]).toEqual([
      0x40, 0x06, 0xe8, 0x03, 0x30, 0x04, 0x90, 0x01, 0x20, 0x03, 0x40, 0x06,
      0x80, 0x0c, 0x02, 0x01, 0, 0, 0, 0, 0, 0x02, 0x07, 0x08, 0x08, 0x08, 0x08,
      0x08, 0x08, 0x08, 0x01, 0x00, 0x01, 0x01, 0x04, 0x01, 0x02, 0x03, 0x04,
      0x08, 0x02, 0x64, 0x00, 0x5a, 0x00, 0x01, 0x04, 0x80, 0x81, 0x82, 0x83,
      0x00,
    ]);
  });
