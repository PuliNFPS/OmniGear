      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            aria-label="Fechar"
            className="absolute top-5 right-5 grid size-9 place-items-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-none disabled:pointer-events-none"
          >
